...
install_grub_theme() {
  ...
  if [[ $INST == "Y" || $INST == "y" ]]; then
    sudo rm -rf /boot/efi/grub/themes/starfield
    sudo mkdir /boot/efi/grub/themes/CyberEXS
    sudo git clone https://github.com/HenriqueLopes42/themeGrub.CyberEXS.git /boot/efi/grub/themes/CyberEXS
    echo 'GRUB_THEME="/boot/efi/grub/themes/CyberEXS/theme.txt"' | sudo tee -a /etc/default/grub
